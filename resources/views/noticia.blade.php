                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="trend-top-cap">
                            ...
                            <h2><a href="#" data-animation="fadeInUp" data-delay=".4s" data-duration="1000ms">{{$noticia->titulo}}</a></h2>
                            <p data-animation="fadeInUp" data-delay=".6s" data-duration="1000ms">by {{$noticia->autor}} - {{$noticia->created_at->format('d/m/Y H:m')}}</p>
                        </div>
                        {{$noticia->texto}}
                    </div>
                    <!-- Right content -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-6 col-sm-6">
                                <div class="trending-top mb-30" style="padding-top: 110px">
                                    <img src="../storage/img_noticia/{{$noticia->url_img}}" width="400">
                                </div>
                            </div>
