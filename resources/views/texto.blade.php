                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="trend-top-cap">
                            <span class="bgr" data-animation="fadeInUp" data-delay=".2s" data-duration="1000ms">Noticia</span>
                            <h2><a href="#" data-animation="fadeInUp" data-delay=".4s" data-duration="1000ms">{{$texto->titulo}}</a></h2>
                            <p data-animation="fadeInUp" data-delay=".6s" data-duration="1000ms">by {{$texto->autor}} - {{$texto->created_at->format('d/m/Y H:m')}}</p>
                        </div>
                        {{$texto->texto}}
                    </div>
                    <!-- Right content -->
                    <div class="col-lg-4">
                        ...
                        <div class="col-lg-12 col-md-6 col-sm-6">
                            <div class="trending-top mb-30" style="padding-top: 110px">
                                <img src="../storage/url_img/{{$texto->url_img}}" width="400">
                            </div>
                        </div>
                                    ...
                                    <div class="weekly2-news-active d-flex">
                                        ...
                                        <div class="weekly2-single">
                                            <div class="weekly2-img">
                                                <img src="{{ asset('tema_pub/assets/img/gallery/weeklyNews1.png') }}" alt="">
                                            </div>
                                        ...
                                        <div class="weekly2-single">
                                            <div class="weekly2-img">
                                                <img src="{{ asset('tema_pub/assets/img/gallery/weeklyNews2.png') }}" alt="">
                                            </div>
                                            <div class="weekly2-caption">
                                                <h4><a href="#">Scarlett’s disappointment at latest accolade</a></h4>
                                                <p>Jhon  |  2 hours ago</p>
                                        ...
                                        <div class="weekly2-single">
                                            <div class="weekly2-img">
                                                <img src="{{ asset('tema_pub/assets/img/gallery/weeklyNews3.png') }}" alt="">
                                            </div>
                                            <div class="weekly2-caption">
                                                <h4><a href="#">Scarlett’s disappointment at latest accolade</a></h4>
                                                <p>Jhon  |  2 hours ago</p>
