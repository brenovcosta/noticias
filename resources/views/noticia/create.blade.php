...
@section('content')
    @if ($u = Session::get('login'))
        ...
        <form action="{{ route('noticia.store') }}" method="POST" class="container was-validated" enctype="multipart/form-data" novalidate="">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    ...
                    <div class="form-group col-md-6">
                        <input type="file" class="form-control wd custom-file-input" id="img_noticia" name="img_noticia" required>
                        <label class="custom-file-label" for="img_noticia">Escoher um arquivo</label>
                    </div>
                </div>
